...
<head>
	...
	<title>Write a Review - Aamar Boi - Online Books Shop</title>
				...
				<div class="col-sm">
					...
					<div>
						<input type="text" name="headline" class="form-control" 
							placeholder="Headline or summary for your review (required)" required  maxlength="128" />
					</div>
					<div>&nbsp;</div>
					<div>
						<textarea name="comment" cols="70" rows="10" class="form-control" 
							placeholder="Write your review details..." required  maxlength="500" ></textarea>
					</div>
				</div>
			</div>
			<div>&nbsp;</div>

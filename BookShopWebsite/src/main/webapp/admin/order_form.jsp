...
<head>
	...
	<title>Edit Order - Aamar Boi - Administration</title>
	...
	<div align="center">
		...
		<table>	
			<tr>
				...
				<td><input type="text" name="firstname" value="${order.firstname}" size="45" required  maxlength="30" /></td>
			</tr>
			<tr>
				<td><b>Last Name: </b></td>
				<td><input type="text" name="lastname" value="${order.lastname}" size="45" required  maxlength="30" /></td>
			</tr>			
			<tr>
				<td><b>Phone: </b></td>
				<td><input type="text" name="phone" value="${order.phone}" size="45" required  maxlength="15" /></td>
			</tr>		
			<tr>
				<td><b>Address Line 1: </b></td>
				<td><input type="text" name="address1" value="${order.addressLine1}" size="45" required  maxlength="256" /></td>
			</tr>
			<tr>
				<td><b>Address Line 2: </b></td>
				<td><input type="text" name="address2" value="${order.addressLine2}" size="45" required  maxlength="256" /></td>
			</tr>
			<tr>
				<td><b>City: </b></td>
				<td><input type="text" name="city" value="${order.city}" size="45" required  maxlength="32" /></td>
			</tr>			
			<tr>
				<td><b>State: </b></td>
				<td><input type="text" name="state" value="${order.state}" size="45" required  maxlength="45" /></td>
			</tr>
			<tr>
				<td><b>Zipcode: </b></td>
				<td><input type="text" name="zipcode" value="${order.zipcode}" size="45" required  maxlength="24" /></td>
			</tr>
			<tr>
				<td><b>Country: </b></td>
				<td>
